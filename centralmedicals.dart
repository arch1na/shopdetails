...
class centralmedicals extends StatefulWidget {
  const centralmedicals({super.key});

  @override
  State<centralmedicals> createState() => _centralmedicalsState();
}

class _centralmedicalsState extends State<centralmedicals> {
  @override
      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      fit: BoxFit.cover,
                      image: AssetImage('assets/images/centralmedi.png'))
              ),
            ),
            Positioned(
                top: 45,
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    width: 110,
                    decoration: BoxDecoration(
                        image: DecorationImage(image: AssetImage('assets/images/medicine.png'))
                    ),
                  ),
                ),
                Padding(
            ...
            //         width: 100,
            //         decoration: BoxDecoration(
            //             image: DecorationImage(image: AssetImage('assets/images/petsart1.png'))
            //         ),
            //       ),
            //     ),
            //     Padding(
            ...
            //           width: 100,
            //           decoration: BoxDecoration(
            //               image: DecorationImage(image: AssetImage('assets/images/petsart2.png'))
            //           )
            //       ),
            //     ),
            //     Padding(
            ...
            //           width: 100,
            //           decoration: BoxDecoration(
            //               image: DecorationImage(image: AssetImage('assets/images/petsart3.png'))
            //           )
            //       ),
            //     )
            //   ],
            ...
            Row(
              children: [
                Padding(
                  padding: const EdgeInsets.only(left: 15,top: 800),
                  child: Container(
                    height: 100,
                    width: 100,
                    decoration: BoxDecoration(
