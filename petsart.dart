...
class petsart extends StatefulWidget {
  const petsart({super.key});

  @override
  State<petsart> createState() => _petsartState();
}

class _petsartState extends State<petsart> {
  @override
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      fit: BoxFit.cover,
                      image: AssetImage('assets/images/artpet.png'))
              ),
            ),
            Positioned(
                top: 45,
